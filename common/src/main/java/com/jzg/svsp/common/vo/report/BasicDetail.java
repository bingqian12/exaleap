...
public class BasicDetail {
    ...
    private int makeId;
    private long stdCityId;
    private int salePrice;
    private long stdProvinceId;
    ...
    public void setCarDealerMan(String carDealerMan) {
         this.carDealerMan = carDealerMan;
     }
    ...
    public void setStdCityId(long stdCityId) {
         this.stdCityId = stdCityId;
     }
     public long getStdCityId() {
         return stdCityId;
     }
    ...
    public void setStdProvinceId(long stdProvinceId) {
         this.stdProvinceId = stdProvinceId;
     }
     public long getStdProvinceId() {
         return stdProvinceId;
     }
