package com.jzg.svsp.common.constant;

/**
 * @Author: jzg
 * @Description:
 * @Date: Created by 10:53 on 2018/9/28.
 */
public class VehicleConstant {
    ...
    public static final String makeName = "makeName"; //车系
    public static final String modelName = "modelName"; //车源ID
    public static final String styleName = "styleName"; //车型名称
    public static final String makeId = "makeId"; //品牌Id
    ...
    public static final String vehcleStatus = "vehcleStatus"; //车源状态
